...
# eWebReputation::Application.config.session_store :active_record_store
EWebReputation::Application.config.session_store :cookie_store

EWebReputation::Application.config.session = {
  :key          => '_ewebreputation_session',     # name of cookie that stores the data
